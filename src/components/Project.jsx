  ...
  return (
    <div className="min-h-screen flex flex-col font-mono text-white">
      <header className="flex flex-1 justify-center ">
        <img
          className="h-full w-full brightness-50 object-cover fixed top-0 left-0 z-0"
          src={htmlTag}
          alt="Asd"
        ></img>
        <h1 className="text-3xl text-white text-center mt-20 relative animate-pulse">
          {project.name}
        </h1>
      </header>
      <main className="flex-1 p-10 h-2/3 flex flex-col gap-10 z-10 ">
        <div className="flex flex-col gap-5">
          ...
          <div className="flex gap-10 bg-slate-900 p-3 max-w-max rounded-2xl">
